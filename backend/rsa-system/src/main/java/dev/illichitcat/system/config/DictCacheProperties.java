...
public class DictCacheProperties {
     ...
     * 缓存键前缀
     */
    private String dictPrefix = "dict:";
    private String dictItemPrefix = "dict_item:";
    private String dictItemsPrefix = "dict_items:";
    ...
    public static class Caffeine {
         ...
         * 异步刷新间隔（分钟）
         */
        private long refreshAfterWriteMinutes = 8;
    }
    ...
    public static class Scheduled {
         ...
         * 缓存预热cron表达式
         */
        private String warmUpCron = "0 0 2 * * ?";
    }
}